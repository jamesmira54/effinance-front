...
import { PoolingFormProps } from "./Pooling.types";
...
const PoolingForm: React.FC<
{
    ...
    const initialValues = useMemo<PoolingFormProps>(() => ({
    ...
    const submitHandler = async (values: PoolingFormProps, setSubmitting: (isSubmitting: boolean) => void) => {
        try {
