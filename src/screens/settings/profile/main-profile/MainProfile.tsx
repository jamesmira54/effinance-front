  ...
  return (
    <>
      <div className="p-5 border border-gray-200 rounded-2xl dark:border-gray-800 lg:p-6 bg-white dark:bg-slate-800">
          ...
          <div className="w-[80%]">
            ...
            <div className="flex flex-col items-center w-full gap-6 xl:flex-row mb-5 justify-between">
              ...
              <div className="flex items-center order-2 gap-2 grow xl:order-3 xl:justify-end">
                <a target="_blank" rel="noreferrer" href='https://www.facebook.com' className="flex h-11 w-11 items-center justify-center gap-2 rounded-full border border-gray-300 bg-white text-sm font-medium text-gray-700 shadow-theme-xs hover:bg-gray-50 hover:text-form-strokedark dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-white/[0.03] dark:hover:text-gray-200"> <svg
                ...
                <a href='https://x.com' target="_blank" rel="noreferrer"  className="flex h-11 w-11 items-center justify-center gap-2 rounded-full border border-gray-300 bg-white text-sm font-medium text-gray-700 shadow-theme-xs hover:bg-gray-50 hover:text-form-strokedark dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-white/[0.03] dark:hover:text-gray-200">
                  <svg
                    className="fill-current"
                    width="20"
                    height="20"
                ...
                <a href='https://instagram.com' target="_blank" rel="noreferrer" className="flex h-11 w-11 items-center justify-center gap-2 rounded-full border border-gray-300 bg-white text-sm font-medium text-gray-700 shadow-theme-xs hover:bg-gray-50 hover:text-form-strokedark dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-white/[0.03] dark:hover:text-gray-200">
                  <svg
                    className="fill-current"
                    width="20"
                    height="20"
            ...
            <div className="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-7 2xl:gap-x-32">
              <div>
                ...
                <p className="text-sm font-medium text-form-strokedark dark:text-white">{userDetails.firstName}</p>
              </div>

              <div>
                <p className="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400"> Middle Name </p>
                <p className="text-sm font-medium text-form-strokedark dark:text-white/90">{userDetails.middleName}</p>
              </div>
              ...
              <div>
                ...
                <p className="text-sm font-medium text-form-strokedark dark:text-white/90">{userDetails.email}</p>
              </div>

              <div>
                <p className="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400"> Mobile Number </p>
                <p className="text-sm font-medium text-form-strokedark dark:text-white/90">{userDetails.mobileNumber}</p>
              </div>
            </div>
          </div>
        ...
        >
            <MainProfileForm userDetails={formData} roles={roles}/>
        </Modal>
      </div>
    </>
  );
