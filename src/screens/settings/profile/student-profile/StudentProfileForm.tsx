...
const StudentProfileForm: React.FC<{studentDetails: APIStudentListResponse}> = ({
    ...
    const formik = useFormik<StudentProfileFormProps>({
        initialValues: { 
            ...
            sex: GenderData.find(option => option.value === studentDetails.sex),
    ...
    const submitHandler = async (values: StudentProfileFormProps, setSubmitting: (isSubmitting: boolean) => void) => {
        try {
